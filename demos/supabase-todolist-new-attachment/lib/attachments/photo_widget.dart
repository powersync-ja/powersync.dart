...
import 'package:powersync_flutter_demo_new/attachments/camera_helpers.dart';
import 'package:powersync_flutter_demo_new/attachments/photo_capture_widget.dart';
...
class _PhotoWidgetState extends State<PhotoWidget> {
  ...
  Future<_ResolvedPhotoState> _getPhotoState(photoId) async {
    ...
    photoPath = attachmentQueue.getLocalUri('$photoId.jpg');
