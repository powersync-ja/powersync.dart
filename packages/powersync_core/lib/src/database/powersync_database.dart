...
abstract base class PowerSyncDatabase extends SqliteConnection {
  ...
  Stream<UpdateNotification> get updates =>
      powerSyncUpdateNotifications(database.updates);
  ...
  factory PowerSyncDatabase.withFactory(
    ...
    return PowerSyncDatabase.withDatabase(
      database: SqliteDatabase.withFactory(openFactory),
      schema: schema,
      logger: logger,
    );
  }
...
@internal
abstract base class BasePowerSyncDatabase extends PowerSyncDatabase {
  @override
  Schema schema;
