...
class Schema {
  ...
  fromJson(Map<String, dynamic> val) {
    return Schema((val['tables'] as List)
        .map((e) => Table(
            e['name'],
            (e['columns'] as List)
                .map((e) => Column(e['name'], ColumnType.values[e['type']]))
                .toList(),
            indexes: (e['indexes'] as List)
                .map((e) => Index(
                    e['name'],
                    (e['columns'] as List)
                        .map((e) =>
                            IndexedColumn(e['name'], ascending: e['ascending']))
                        .toList()))
                .toList(),
